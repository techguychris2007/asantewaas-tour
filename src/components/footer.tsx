...
// ✏️ UPDATE YOUR WHATSAPP NUMBER BELOW (include country code, no + or spaces)
const WHATSAPP_NUMBER = "233243954716"; // e.g. 233244123456 for Ghana (+233)
        ...
        <div className="grid gap-12 md:grid-cols-3">
          <div>
            ...
            <a
              ...
              className="mt-6 inline-flex items-center gap-2 rounded-full bg-[#25D366] px-5 py-2.5 text-sm font-semibold text-white hover:bg-[#1ebe5d] transition-colors"
            >
          ...
          <div>
            ...
            <p className="eyebrow mb-3 mt-8 text-gold">Also available</p>
